...
// import 'package:data/services/tourer_annual_service_pdf.dart';
...
// class TourerAnnualServiceScreen extends StatefulWidget {
//   @override
//   _TourerAnnualServiceScreenState createState() => _TourerAnnualServiceScreenState();
// }

// class _TourerAnnualServiceScreenState extends State<TourerAnnualServiceScreen> {
//   final TourerAnnualServiceModel formData = TourerAnnualServiceModel();
...
//       final pdfBytes = await TourerAnnualPDf.generatePdf(
//         formData,
...
//         bytes: pdfBytes,
//         filename: 'tourer-annual-service-form.pdf',
//       );
...
//                   onChanged: (value) {
//                     setState(() {
//                       formData.batteryRestVoltage = value;
//                     });
//                   },
//                 ),
//               ),
...
class _TourerAnnualServiceScreenState extends State<TourerAnnualServiceScreen> {
  ...
  late TextEditingController smokeCOAlarmCommentsController;
  ...
  void initState() {
    ...
    smokeCOAlarmCommentsController = TextEditingController(text: formData.smokeCOAlarmComments);
    ...
    smokeCOAlarmCommentsController.addListener(() => formData.smokeCOAlarmComments = smokeCOAlarmCommentsController.text);
  ...
  void dispose() {
    ...
    smokeCOAlarmCommentsController.dispose();
          ...
          Column(
            ...
            children: [
              Container(
                ...
                child: TextFormField(
                  controller: smokeCOAlarmCommentsController,
                  decoration: InputDecoration(
                    border: InputBorder.none,
                    contentPadding: const EdgeInsets.all(16),
                    hintText: 'Enter* Comments (Optional)',
