...
class StaticCarvanDampReportPdfService {
  static Future<Uint8List> generatePdf(
    ...
    // =========== PAGE 3: Nearside & Offside Photos (RECTANGULAR) ===========
    pdf.addPage(
      pw.Page(
        pageFormat: PdfPageFormat.a4,
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              // Nearside & Offside Photos (Rectangular/Square format)
              pw.Column(
                children: [
                  // Nearside Photo Section
                  _buildSquarePhotoSection('Nearside', formData.photoData['Nearside'] ?? {}),
                  pw.SizedBox(height: 10),
                  
                  // Offside Photo Section
                  _buildSquarePhotoSection('Offside', formData.photoData['Offside'] ?? {}),
                ],
              ),
            ],
          );
      ...
      pw.Page(
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              // Header Section
              _buildHeader(formData, logoImage, 5),
              pw.SizedBox(height: 15),
 ...
 // ==================== RECTANGULAR SQUARE-TYPE PHOTO SECTION (for Nearside/Offside) ====================
static pw.Widget _buildSquarePhotoSection(String title, Map<String, dynamic> data) {
  bool hasImage = data['attachedFileBytes'] != null;
  String comments = data['comments']?.toString() ?? '';
  ...
  return pw.Container(
    ...
    child: pw.Column(
      ...
      children: [
        ...
        // Center the square image container
        pw.Center(
          child: pw.Container(
            height: 200, // Square height
            width: 280,  // Square width - BOTH SAME FOR SQUARE!
            padding: const pw.EdgeInsets.all(8),
            child: hasImage
                ? pw.Image(
                    pw.MemoryImage(data['attachedFileBytes'] as Uint8List),
  ...
  // ==================== PHOTO SECTION WITH TABLE STRUCTURE (for other sections) ====================
  static pw.Widget _buildPhotoSectionWithTable(String title, Map<String, dynamic> data) {
    bool hasImage = data['attachedFileBytes'] != null;
    String comments = data['comments']?.toString() ?? '';
    ...
    return pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          ...
          // Image Container (Normal size for other sections)
          pw.Container(
            height: 150,
            width: double.infinity,
            padding: const pw.EdgeInsets.all(8),
