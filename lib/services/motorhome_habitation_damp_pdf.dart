...
// class MotorhomeHabitationDampReportPdfService {
...
//     //   ),
//     // );
//     // // =========== PAGE 4: Photo Documentation (Nearside, Offside) ===========
//     // pdf.addPage(
//     //   pw.Page(
//     //     pageFormat: PdfPageFormat.a4,
//     //     build: (pw.Context context) {
...
//     // // =========== PAGE 5: Remaining Photos and Finalization ===========
//     // pdf.addPage(
//     //   pw.Page(
//     //     pageFormat: PdfPageFormat.a4,
//     //     build: (pw.Context context) {
...
//                 children: [
//                   pw.Expanded(
//                     child: _buildPhotoSectionWithTable(
//                         'Front', formData.photoData['Front'] ?? {}),
//                   ),
//                   pw.SizedBox(width: 10),
//                   pw.Expanded(
//                     child: _buildPhotoSectionWithTable(
//                         'Rear', formData.photoData['Rear'] ?? {}),
//                   ),
//                 ],
//               ),
//               // Footer
...
// // =========== PAGE 4: Nearside & Offside Photos ===========
//     pdf.addPage(
//       pw.Page(
//         pageFormat: PdfPageFormat.a4,
//         build: (pw.Context context) {
...
//                   pw.Expanded(
//                     child: _buildPhotoSectionWithTable(
//                         'Nearside', formData.photoData['Nearside'] ?? {}),
//                   ),
//                   pw.SizedBox(width: 10),
//                   pw.Expanded(
//                     child: _buildPhotoSectionWithTable(
//                         'Offside', formData.photoData['Offside'] ?? {}),
//                   ),
//                 ],
//               ),
...
//                   pw.Expanded(
//                     child: _buildPhotoSectionWithTable(
//                         'Ceiling', formData.photoData['Ceiling'] ?? {}),
//                   ),
//                   pw.SizedBox(width: 10),
//                   pw.Expanded(
//                     child: _buildPhotoSectionWithTable(
//                         'Floor', formData.photoData['Floor'] ?? {}),
//                   ),
//                 ],
//               ),
//               pw.SizedBox(height: 15),
...
//                 children: [
//                   pw.Text(
//                     'Motorhome Habitation Damp Report',
//                     style: pw.TextStyle(
//                       fontSize: 14,
//                       fontWeight: pw.FontWeight.bold,
//                     ),
...
//   static pw.Widget _buildPhotoSectionWithTable(
...
//               padding: const pw.EdgeInsets.all(6.0),
//               child: pw.Text(
//                 formData.dampMeterCalibration.isNotEmpty
//                     ? formData.dampMeterCalibration
//                     : 'Not provided',
//                 style: pw.TextStyle(fontSize: 9),
//               ),
//             ),
...
//               padding: const pw.EdgeInsets.all(6.0),
//               child: pw.Text(
//                 formData.dampMeterMakeModel.isNotEmpty
//                     ? formData.dampMeterMakeModel
//                     : 'Not provided',
//                 style: pw.TextStyle(fontSize: 9),
//               ),
//             ),
...
//               padding: const pw.EdgeInsets.all(6.0),
//               child: pw.Text(
//                 formData.weatherConditions.isNotEmpty
...
//               padding: const pw.EdgeInsets.all(6.0),
//               child: pw.Text(
//                 formData.ambientTemperature.isNotEmpty
...
//               padding: const pw.EdgeInsets.all(6.0),
//               child: pw.Text(
//                 formData.serviceTechnicianName.isNotEmpty
//                     ? formData.serviceTechnicianName
//                     : 'Not provided',
//                 style: pw.TextStyle(fontSize: 9),
//               ),
//             ),
...
//               padding: const pw.EdgeInsets.all(6.0),
//               child: pw.Text(
//                 formData.technicianSignatureText.isNotEmpty
//                     ? formData.technicianSignatureText
//                     : 'Not provided',
//                 style: pw.TextStyle(fontSize: 9),
//               ),
//             ),
...
//               padding: const pw.EdgeInsets.all(6.0),
//               child: pw.Text(
//                 formData.customerSignatureText.isNotEmpty
//                     ? formData.customerSignatureText
//                     : 'Not provided',
//                 style: pw.TextStyle(fontSize: 9),
//               ),
//             ),
